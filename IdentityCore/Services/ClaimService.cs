...
namespace IdentityCore.Services
{
    public class ClaimService : IClaimService
    {
        ...
        public async Task<IList<ClaimDto>> GetClaimsRoleAsync(string roleName)
        {
            try
            {
        ...
        public async Task<IList<ClaimDto>> GetClaimsUserAsync(string userId)
        {
            try
            {
        ...
        public async Task<IdentityResult> UpdateClaimsForRoleAsync(IList<ClaimDto> claimDtos, string roleName)
        {
            try
            {
                var role = await _roleManager.FindByNameAsync(roleName);
        ...
        public async Task<IdentityResult> UpdateClaimsForUserAsync(IList<ClaimDto> claimDtos, string userId)
        {
            try
            {
                var user = await _userManager.FindByIdAsync(userId);
